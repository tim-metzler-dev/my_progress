Today I made the website and I used background-image. It was funny and I think it had some very awesome style!
It looks like an old pergament with cyberpunk stickers on it. The style is style5.css. I also learned url-ing the backgroundpicture in CSS. It was an interesting story!
...
<html lang="en">
    ...
    <body>
        ...
        <section class="Welcoming">
            ...
            <figure>
                <img src="Pictures/head.jpg" alt="All pens on a wooden table with two cards with the text bungu." width="300" id="startpicture">
                <figcaption id="new">Well isn't this exciting? Are you ready to choose your new Friend?</figcaption>
            </figure>
        </section>
        <nav>
        ...
        <section>
            <table>
                <caption id="tableofpens">Pen-Table</caption>
                <thead>
                    <tr>
                        <th>Pen</th>
                        <th>Price</th>
        ...
        <section id="0,38_budget">
            <img src="Pictures/0,38.jpg" alt="0,38mm Pen with diamond tip and a wooden background" width="500">
                <p class="price">Price: 0,79&euro;</p>
                <button class="add-to-cart">Add to cart</button>
        </section>
        <section id="0,5_budget"></section>
            <img src="Pictures/0,5.jpg" alt="0,5mm Pen with blur style and a wooden background" width="500">
                <p class="price">Price: 0,99&euro;</p>
                <button class="add-to-cart">Add to cart</button>
       </section>
       <section id="classics">
        <section id="0,35_pens">
            <h2>The classics</h2>
            <img src="Pictures/0,35.jpg" alt="0,35mm Pen with a wooden background" width="500">
            <ul>
                <li class="price">Price for one: 1,50&euro;</li>
                <li class="price">Price for three: 3,00&euro;</li>
            </ul>
        ...
        <section id="0,35_refills">
            ...
            <p class="price">Buy one for 0,79&euro;</p>
            <button class="add-to-cart">Add to cart</button>
        </section>
       </section>
       <br /><hr />
        <section class="review" id="reviews">
            ...
            <figure id="neal">
                <iframe width="774" height="435" src="https://www.youtube.com/embed/YqXXMqpWvZY" title="0 35 mm Black Gel Ink Pen Review &amp; Unboxing" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                <figcaption><dl>
                    <dt class="review">Neal</dt>
                    <dd class="review">Neal sais Thumbs up!</dd>
                </dl></figcaption>
            </figure>
            </figure>
            <figure id="tony">
                ...
                <figcaption><dl>
                    <dt class="review">Tony</dt>
                    <dd class="review">Tony likes the smothe ink flow and thinks these are good pens.</dd>
                </dl></figcaption>
            </figure>
            <section id="make_yours" class="review">
